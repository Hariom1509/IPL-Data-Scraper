...
def save_data(data, columns, data_set_name, file_name):
    ...
    print(data_set_name + 'is saved as: ' + os.path.dirname(os.path.abspath(__file__)) + '/' + data_set_name + '.csv')
...
def get_page(url, team):
    try:
        ...
        if page.status_code == 200:
            ...
            print('Sorry, could not reach the website')
            return
...
if __name__ == '__main__':
    try:
        ...
        print('Hey, you can use terminal')
